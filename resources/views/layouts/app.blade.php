    ...
    <div id="app">
        <header class="bg-orange-500 py-6">
            <div class="container mx-auto flex justify-between items-center px-6">
                ...
                <nav class="space-x-4 text-white text-sm font-bold sm:text-base">
                    @guest
